...
describe("isolated synthetic preview configuration", () => {
  ...
  it.each(["NEXT_PUBLIC_SUPABASE_URL", "SUPABASE_SECRET_KEY", "SUPABASE_ACCESS_TOKEN",
    ...
    "FINANCE_STORE_BRANCH_ID", "FINANCE_STORE_ENTITY_ID", "CLIENT_DOCUMENTS_SCANNER_APPROVED",
    "CLIENT_DOCUMENTS_SCANNER_ACCESS_MODE", "CLIENT_DOCUMENTS_CLAMAV_HOST",
    "CLIENT_DOCUMENTS_CLAMAV_CLIENT_KEY_PEM", "CLIENT_DOCUMENTS_CLAMAV_CLIENT_CERT_PEM", "CLIENT_DOCUMENTS_CLAMAV_CA_PEM"])(
