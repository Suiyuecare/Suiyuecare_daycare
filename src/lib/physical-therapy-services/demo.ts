import {
  filterDemoPhysicalTherapyServiceSnapshot,
...
const ORGANIZATION_ID = "34000000-0000-4000-8000-000000000001";
const BRANCH_ID = "34000000-0000-4000-8000-000000000002";
const THERAPIST_ID = "34000000-0000-4000-8000-000000000003";
const SECOND_THERAPIST_ID = "34000000-0000-4000-8000-000000000004";
const CLIENT_ONE = "34000000-0000-4000-8000-000000000011";
const CLIENT_TWO = "34000000-0000-4000-8000-000000000012";
const CLIENT_THREE = "34000000-0000-4000-8000-000000000013";
...
export function buildDemoPhysicalTherapyServiceSnapshot(
  ...
  const recordThreeOccurred = isoHoursBefore(generated, 32);
  const recordOneAssessment = {
    status: "linked" as const,
    version_id: "34000000-0000-4000-8000-000000000061",
    assessment_key: "34000000-0000-4000-8000-000000000062",
    assessment_version: 2,
    assessed_on: isoHoursBefore(generated, 96).slice(0, 10),
    therapist_display_name: "王物理治療師（合成）",
  };
  const recordTwoAssessment = {
    status: "linked" as const,
    version_id: "34000000-0000-4000-8000-000000000071",
    assessment_key: "34000000-0000-4000-8000-000000000072",
    assessment_version: 3,
    assessed_on: isoHoursBefore(generated, 240).slice(0, 10),
    therapist_display_name: "林物理治療師（合成）",
  };
  ...
  const source: PhysicalTherapyServiceSnapshotSourceRow = {
    organization_id: ORGANIZATION_ID,
    branch_id: BRANCH_ID,
    generated_at: generated.toISOString(),
    records: [
      {
        record_key: "34000000-0000-4000-8000-000000000021",
        version_id: "34000000-0000-4000-8000-000000000023",
        record_version: 2,
        record_state: "signed",
        client_id: CLIENT_ONE,
        client_display_name: "合成個案・晨光",
        occurred_at: recordOneOccurred,
        service_content: recorded("依人工計畫進行坐站轉位與步行練習。"),
        ...
        signer_display_name: "王物理治療師（合成）",
        created_at: isoHoursBefore(generated, 1.5),
        version_history: [
          {
            version_id: "34000000-0000-4000-8000-000000000022",
            record_version: 1,
            record_state: "draft",
            occurred_at: recordOneOccurred,
            service_content: recorded("依人工計畫進行坐站轉位與步行練習。"),
      ...
      {
        record_key: "34000000-0000-4000-8000-000000000031",
        version_id: "34000000-0000-4000-8000-000000000034",
        record_version: 3,
        record_state: "corrected",
        client_id: CLIENT_TWO,
        client_display_name: "合成個案・青松",
        occurred_at: recordTwoOccurred,
        service_content: recorded("進行人工記錄的關節活動與平衡練習。"),
        ...
        signer_display_name: "林物理治療師（合成）",
        created_at: isoHoursBefore(generated, 20),
        version_history: [
          {
            version_id: "34000000-0000-4000-8000-000000000032",
            record_version: 1,
            record_state: "draft",
            occurred_at: recordTwoOccurred,
            service_content: recorded("進行人工記錄的關節活動與平衡練習。"),
          ...
          {
            version_id: "34000000-0000-4000-8000-000000000033",
            record_version: 2,
            record_state: "signed",
            occurred_at: recordTwoOccurred,
            service_content: recorded("進行人工記錄的關節活動與平衡練習。"),
      ...
      {
        record_key: "34000000-0000-4000-8000-000000000041",
        version_id: "34000000-0000-4000-8000-000000000042",
        record_version: 1,
        record_state: "draft",
        client_id: CLIENT_THREE,
        client_display_name: "合成個案・晴川",
        occurred_at: recordThreeOccurred,
        service_content: recorded("人工草稿：練習場內步行與轉向。"),
    ...
    therapist_options: [
      { user_id: THERAPIST_ID, display_name: "王物理治療師（合成）" },
      { user_id: SECOND_THERAPIST_ID, display_name: "林物理治療師（合成）" },
    ],
    therapist_total: 2,
  ...
  const snapshot = projectPhysicalTherapyServiceSnapshot({
    row: source,
  ...
  return filters
    ? filterDemoPhysicalTherapyServiceSnapshot(snapshot, filters)
    : snapshot;
}
