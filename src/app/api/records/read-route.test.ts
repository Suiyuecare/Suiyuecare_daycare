...
describe("care diary read projection",()=>{
  beforeEach(()=>{vi.resetAllMocks();stubs.authorize.mockResolvedValue({organizationId:id,branchId:id,userId:id,demo:false,scopes:["care_records.read"]});stubs.client.mockResolvedValue({rpc:stubs.rpc});});
