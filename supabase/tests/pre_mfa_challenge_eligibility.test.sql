...
select ('58400000-0000-4000-8000-' || lpad(n::text, 12, '0'))::uuid,
  (case n when 7 then '10000000-0000-4000-8000-000000000010' when 8 then '10000000-0000-4000-8000-000000000001'
    -- Fixture 16 exercises organization-wide membership, which is exclusively
    -- a multi-site administrator template rather than a single-site manager.
    when 16 then '10000000-0000-4000-8000-000000000002'
